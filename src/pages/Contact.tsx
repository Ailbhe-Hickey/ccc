      ...
      <HeroWithNav
        title={
          <>
            ...
            <span className="text-[#454851]">Ballincollig</span>.
          </>
        }
        subtitle="Team A is the pride of the club with champions all around."
        imageSrc="/teamA_photo.jpg"
        buttonText="Join Team A"
